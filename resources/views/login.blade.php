      ...
      <div class="modal-content rounded-5 shadow">
        ...
        <div class="modal-body p-5 pt-0">
          <form action="/masuk" method="post">
              ...
              <a href="/daftarklien" class="w-100 py-2 mb-2 btn btn-outline-primary rounded-4">Klien</a>
              <a href="/daftarfasilitator" class="w-100 py-2 mb-2 btn btn-outline-primary rounded-4">Fasilitator</a>
          </form>
        </div>
      </div>
    </div>
