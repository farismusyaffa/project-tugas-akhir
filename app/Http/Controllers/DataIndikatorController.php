...
class DataIndikatorController extends Controller
{
    ...
    public function showFasilitator(DataIndikator $dataIndikator, $id)
    {
    ...
    public function showDashboardFasilitator(DataIndikator $dataIndikator, $id)
    {
        ...
        // dd(json_encode($jumlahDataBulan));
        return view('fasilitator.showdashboardfasilitator',[
            'title'=>'Dashboard Data Indikator',
            'indikator' =>$indikator,
            // 'platform'=> $platform,
            'dataIndikator'=>$dataIndikator,
