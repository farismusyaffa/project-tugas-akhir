...
class IndikatorController extends Controller
{
    ...
    public function showFasilitator(Indikator $indikator, $id)
    {
        $platform = Platform::find($id);
        $indikator = Indikator::where('platform_id', $id)->get();
        $fasilitator = Fasilitator::all();
        return view('fasilitator.indikatorfasilitator',[
            'title'=>'Indikator Platform',
            'platform'=> $platform,
            'fasilitator'=>$fasilitator,
            'indikator' =>$indikator
    ...
    public function showIndikatorFasilitator(Indikator $indikator, $id)
    {
        $platform = Platform::find($id);
        $indikator = Indikator::where('platform_id', $id)->get();
        $fasilitator = Fasilitator::all();
        return view('fasilitator.dashboardfasilitator',[
            'title'=>'Dashboard Platform',
            'platform'=> $platform,
            'fasilitator'=>$fasilitator,
            'indikator' =>$indikator
